...
public class ReacherRobot : Agent
{
    ...
    {
        sensor.AddObservation(pendulumA.transform.position - basePosition);
        ...
        sensor.AddObservation(pendulumB.transform.position - basePosition);
        ...
        sensor.AddObservation(pendulumC.transform.position - basePosition);
        ...
        sensor.AddObservation(pendulumD.transform.position - basePosition);
        ...
        sensor.AddObservation(pendulumE.transform.position - basePosition);
        ...
        sensor.AddObservation(pendulumF.transform.position - basePosition);
        ...
        sensor.AddObservation(hand.transform.position - basePosition);
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        if (pendulumF.transform.position.y < 0.2)
        {
            AddReward(-0.01f);
            EndEpisode();
        }
